            ...
            <form action="functions/profile_process.php" method="POST" enctype="multipart/form-data">
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <img class="img-account-profile rounded-circle mb-2" style="width:220px;height:220px;"
                            src="<?php echo $row['register_profile_picture'] ?>" alt>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="username" class="form-control" type="text" placeholder="Enter your username"
                            value="<?php echo $row['register_user_name']; ?>">
                    </div>

                    <div class="row gx-3 mb-3">
                        <div class="col-md-6">
                            <label class="small mb-1" for="inputFullName">Full name</label>
                            <input name="fullname" class="form-control" type="text" placeholder="Enter your full name"
                                value="<?php echo $row['register_full_name']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="small mb-1" for="inputPassword">Password</label>
                            <input name="password" class="form-control" type="text" placeholder="Enter your Password"
                                value="<?php echo $row['register_password']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="row gx-3 mb-3">
                        <div class="mb-3">
                            ...
                            <input name="email" class="form-control" type="email" placeholder="Enter your email address"
                                value="<?php echo $row['register_email']; ?>">
                        </div>
                        ...
                        <div class="row gx-3 mb-3">
                            <div class="mb-3">
                                ...
                                <input name="contact" class="form-control" type="tel"
                                    ...
                                    value="<?php echo $row['register_contact_number']; ?>">
                            </div>
                        </div>
